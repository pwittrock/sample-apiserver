...
type ZeldasCastleLister interface {
	...
	List(selector labels.Selector) (ret []*v3.ZeldasCastle, err error)
...
// List lists all ZeldasCastles in the indexer.
func (s *zeldasCastleLister) List(selector labels.Selector) (ret []*v3.ZeldasCastle, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v3.ZeldasCastle))
	})
	return ret, err
}
...
type ZeldasCastleNamespaceLister interface {
	...
	Get(name string) (*v3.ZeldasCastle, error)
...
// List lists all ZeldasCastles in the indexer for a given namespace.
func (s zeldasCastleNamespaceLister) List(selector labels.Selector) (ret []*v3.ZeldasCastle, err error) {
...
// Get retrieves the ZeldasCastle from the indexer for a given namespace and name.
func (s zeldasCastleNamespaceLister) Get(name string) (*v3.ZeldasCastle, error) {
	...
	return obj.(*v3.ZeldasCastle), nil
}

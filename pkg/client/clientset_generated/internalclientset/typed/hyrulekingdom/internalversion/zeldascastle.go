...
type ZeldasCastleInterface interface {
	Create(*hyrulekingdom.ZeldasCastle) (*hyrulekingdom.ZeldasCastle, error)
	Update(*hyrulekingdom.ZeldasCastle) (*hyrulekingdom.ZeldasCastle, error)
	UpdateStatus(*hyrulekingdom.ZeldasCastle) (*hyrulekingdom.ZeldasCastle, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*hyrulekingdom.ZeldasCastle, error)
	List(opts v1.ListOptions) (*hyrulekingdom.ZeldasCastleList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *hyrulekingdom.ZeldasCastle, err error)
...
func newZeldasCastles(c *HyrulekingdomClient, namespace string) *zeldasCastles {
...
func (c *zeldasCastles) Create(zeldasCastle *hyrulekingdom.ZeldasCastle) (result *hyrulekingdom.ZeldasCastle, err error) {
	result = &hyrulekingdom.ZeldasCastle{}
	err = c.client.Post().
		Namespace(c.ns).
...
func (c *zeldasCastles) Update(zeldasCastle *hyrulekingdom.ZeldasCastle) (result *hyrulekingdom.ZeldasCastle, err error) {
	result = &hyrulekingdom.ZeldasCastle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("zeldascastles").
...
func (c *zeldasCastles) UpdateStatus(zeldasCastle *hyrulekingdom.ZeldasCastle) (result *hyrulekingdom.ZeldasCastle, err error) {
	result = &hyrulekingdom.ZeldasCastle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("zeldascastles").
...
func (c *zeldasCastles) Get(name string, options v1.GetOptions) (result *hyrulekingdom.ZeldasCastle, err error) {
	result = &hyrulekingdom.ZeldasCastle{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("zeldascastles").
...
func (c *zeldasCastles) List(opts v1.ListOptions) (result *hyrulekingdom.ZeldasCastleList, err error) {
	result = &hyrulekingdom.ZeldasCastleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("zeldascastles").
...
func (c *zeldasCastles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *hyrulekingdom.ZeldasCastle, err error) {
	result = &hyrulekingdom.ZeldasCastle{}

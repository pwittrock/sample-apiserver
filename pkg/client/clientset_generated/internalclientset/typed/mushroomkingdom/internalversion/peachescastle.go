...
type PeachesCastleInterface interface {
	Create(*mushroomkingdom.PeachesCastle) (*mushroomkingdom.PeachesCastle, error)
	Update(*mushroomkingdom.PeachesCastle) (*mushroomkingdom.PeachesCastle, error)
	UpdateStatus(*mushroomkingdom.PeachesCastle) (*mushroomkingdom.PeachesCastle, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*mushroomkingdom.PeachesCastle, error)
	List(opts v1.ListOptions) (*mushroomkingdom.PeachesCastleList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *mushroomkingdom.PeachesCastle, err error)
...
func newPeachesCastles(c *MushroomkingdomClient, namespace string) *peachesCastles {
...
func (c *peachesCastles) Create(peachesCastle *mushroomkingdom.PeachesCastle) (result *mushroomkingdom.PeachesCastle, err error) {
	result = &mushroomkingdom.PeachesCastle{}
	err = c.client.Post().
		Namespace(c.ns).
...
func (c *peachesCastles) Update(peachesCastle *mushroomkingdom.PeachesCastle) (result *mushroomkingdom.PeachesCastle, err error) {
	result = &mushroomkingdom.PeachesCastle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("peachescastles").
...
func (c *peachesCastles) UpdateStatus(peachesCastle *mushroomkingdom.PeachesCastle) (result *mushroomkingdom.PeachesCastle, err error) {
	result = &mushroomkingdom.PeachesCastle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("peachescastles").
...
func (c *peachesCastles) Get(name string, options v1.GetOptions) (result *mushroomkingdom.PeachesCastle, err error) {
	result = &mushroomkingdom.PeachesCastle{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("peachescastles").
...
func (c *peachesCastles) List(opts v1.ListOptions) (result *mushroomkingdom.PeachesCastleList, err error) {
	result = &mushroomkingdom.PeachesCastleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("peachescastles").
...
func (c *peachesCastles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *mushroomkingdom.PeachesCastle, err error) {
	result = &mushroomkingdom.PeachesCastle{}

...
func DeepCopy_hyrule_HyruleCastleList(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if in.Items != nil {
			...
			*out = make([]HyruleCastle, len(*in))
			for i := range *in {
				if err := DeepCopy_hyrule_HyruleCastle(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
func DeepCopy_hyrule_HyruleCastleSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
...
func DeepCopy_hyrule_HyruleCastleStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{

...
import (
	...
	"k8s.io/sample-apiserver/apis/wardle/v1alpha1"
	"k8s.io/sample-apiserver/pkg/defaults"
)

// Use the override strategy and embedd the defaults for anything not override.
var singletonFlunderStrategy = &FlunderStrategy{DefaultFlunderStrategy{
...
func (w *wardleProvider) GetImportPrefix() string {
	return "k8s.io/sample-apiserver/apis/wardle"
}

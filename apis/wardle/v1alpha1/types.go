...
// +k8s:openapi-gen=x-kubernetes-api-type:true
// +k8s:openapi-gen=x-kubernetes-version:v1alpha1
// +k8s:openapi-gen=x-kubernetes-group:wardle
// +k8s:openapi-gen=x-kubernetes-kind:Flunder
type Flunder struct {

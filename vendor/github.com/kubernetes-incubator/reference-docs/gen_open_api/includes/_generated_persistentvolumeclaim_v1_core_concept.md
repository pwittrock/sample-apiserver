...
selector <br /> *[LabelSelector](#labelselector-v1)*  | A label query over volumes to consider for binding.
storageClassName <br /> *string*  | Name of the StorageClass required by the claim. More info: http://kubernetes.io/docs/user-guide/persistent-volumes#class-1

...
firstTimestamp <br /> *[Time](#time-v1)*  | The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)
...
lastTimestamp <br /> *[Time](#time-v1)*  | The time at which the most recent occurrence of this event was recorded.
...
Code         | Description
------------ | -----------
200 <br /> *[EventList](#eventlist-v1)*  | OK

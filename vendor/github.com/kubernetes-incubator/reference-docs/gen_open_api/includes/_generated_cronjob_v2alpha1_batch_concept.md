...
failedJobsHistoryLimit <br /> *integer*  | The number of failed finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified.
...
successfulJobsHistoryLimit <br /> *integer*  | The number of successful finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified.
...
lastScheduleTime <br /> *[Time](#time-v1)*  | LastScheduleTime keeps information of when was the last time the job was successfully scheduled.
